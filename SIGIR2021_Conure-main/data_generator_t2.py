...
def main():
    ...
    if not os.path.isdir('data/T2'):
        os.makedirs('data/T2')

    # Run myopen
    f0 = open("data/T2/period_0.txt", "w")
    f1 = open("data/T2/period_1.txt", "w")
    f2 = open("data/T2/period_2.txt", "w")
    f3 = open("data/T2/period_3.txt", "w")
    f4 = open("data/T2/period_4.txt", "w")
    f5 = open("data/T2/period_5.txt", "w")
    f6 = open("data/T2/period_6.txt", "w")
    f7 = open("data/T2/period_7.txt", "w")
    f8 = open("data/T2/period_8.txt", "w")
    f9 = open("data/T2/period_9.txt", "w")
    f10 = open("data/T2/period_10.txt", "w")
    f11 = open("data/T2/period_11.txt", "w")
    f12 = open("data/T2/period_12.txt", "w")
    f13 = open("data/T2/period_13.txt", "w")
    f14 = open("data/T2/period_14.txt", "w")
    f15 = open("data/T2/period_15.txt", "w")
    f16 = open("data/T2/period_16.txt", "w")
